...
import android.com.viper.model.network.AndroidViperRepository
import android.com.viper.model.network.CatsApi
...
open class NetworkModule {
  ...
  @Provides @Singleton fun provideRepository(retrofit: Retrofit, context: Context): Repository {
    return AndroidViperRepository(retrofit, CatsApi::class.java, context)
  }
